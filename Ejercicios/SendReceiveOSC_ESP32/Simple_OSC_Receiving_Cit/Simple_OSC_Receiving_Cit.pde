...
void oscEvent(OscMessage theOscMessage) {
  ...
  if (theOscMessage.addrPattern().equals("/myMessage")) { // indicate the ID of the messages
    ...
    println("OSC Messages says= "  + data[0] + "OSC Message 2 says= "  + data[1]);
  }
}
...
void info() {
  ...
  fill(255);
  textAlign(LEFT);
  text("OSC Message 1 Says= " + data[0], 20, height-25);
 // text("OSC Message 2 Says= " + data[1], 20, height-50);
}

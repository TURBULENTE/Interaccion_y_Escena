...
Durante este módulo, haremos varios ejercicios de electrónica y programación. Deberéis crearos un repositorio en Github para poder documentar vuestros ejercicios y resultados. Tomad en cuenta este espacio como si se tratase de un cuaderno de notas en el que podréis añadir también fotografías y los códigos que habéis probado.

Documentad vuestro trabajo de cada sesión del módulo en una carpeta diferente.
